				...
				<div class="form-w3agile">
					...
					<form action="#" method="post">
						<div class="key">
							...
							<input  type="text" value="Receipant Name" name="Username" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Username';}" required="">
							<div class="clearfix"></div>
						</div>
						<div class="key">
							<i class="far fa-database" aria-hidden="true"></i>
							<input  type="text" value="Home Address" required="">
							<div class="clearfix"></div>
						</div>
						<div class ="key">
